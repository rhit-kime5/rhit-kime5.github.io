"object" == typeof navigator && function (e, t) {
    ...
    var c = function (e) {
        ...
        g = {
            ...
            empty: function (e) {
                return d(e) || (m(e) || p(e) || f(e)) && !e.length || h(e) && !Object.keys(e).length
            }
        };
    ...
    var v, b, k, w = function () {
            function t(n, i) {
                e(this, t), g.element(n) ? this.element = n : g.string(n) && (this.element = document.querySelector(n)), g.element(this.element) && g.empty(this.element.rangeTouch) && (this.config = Object.assign({}, l, i), this.init())
            }
            return n(t, [{
                key: "init",
                value: function () {
                ...
                value: function (e) {
                    ...
                    return (n = 100 / c.width * (a.clientX - c.left)) < 0 ? n = 0 : n > 100 && (n = 100), n < 50 ? n -= (100 - 2 * n) * u : n > 50 && (n += 2 * (n - 50) * u), s + y(l * (n / 100), o)
                }
            }, {
                key: "set",
                value: function (e) {
                    t.enabled && g.event(e) && !e.target.disabled && (e.preventDefault(), e.target.value = this.get(e), function (e, t) {
                        if (e && t) {
                            var n = new Event(t);
                            e.dispatchEvent(n)
                        }
                ...
                value: function (e) {
                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        i = null;
                    if (g.empty(e) || g.string(e) ? i = Array.from(document.querySelectorAll(g.string(e) ? e : 'input[type="range"]')) : g.element(e) ? i = [e] : g.nodeList(e) ? i = Array.from(e) : g.array(e) && (i = e.filter(g.element)), g.empty(i)) return null;
                    var a = Object.assign({}, l, n);
                    g.string(e) && a.watch && new MutationObserver(function (n) {
                        Array.from(n).forEach(function (n) {
                            Array.from(n.addedNodes).forEach(function (n) {
                                if (g.element(n) && function () {
        ...
        M = function (e) {
            return A(e) || (S(e) || P(e) || N(e)) && !e.length || E(e) && !Object.keys(e).length
        },
        x = {
            nullOrUndefined: A,
            object: E,
        ...
        L = (v = document.createElement("span"), b = {
    ...
    function j() {
        ...
        var s = n.shift();
        return x.object(s) ? (Object.keys(s).forEach(function (t) {
            x.object(s[t]) ? (Object.keys(e).includes(t) || Object.assign(e, i({}, t, {})), j(e[t], s[t])) : Object.assign(e, i({}, t, s[t]))
    ...
    function H(e, t) {
        x.element(e) && !x.empty(t) && Object.entries(t).filter(function (e) {
            var t = r(e, 2)[1];
    ...
    function R(e) {
        x.nodeList(e) || x.array(e) ? Array.from(e).forEach(R) : x.element(e) && x.element(e.parentNode) && e.parentNode.removeChild(e)
    }
    ...
    function B(e, t) {
        return x.element(t) && x.element(t.parentNode) && x.element(e) ? (t.parentNode.replaceChild(e, t), e) : null
    }
    ...
    function U(e, t) {
        ...
        return e.split(",").forEach(function (e) {
            ...
            switch (t.charAt(0)) {
                case ".":
                    x.string(i.class) ? n.class = "".concat(i.class, " ").concat(a) : n.class = a;
                    break;
                case "#":
                    n.id = t.replace("#", "");
                    break;
    ...
    function z(e, t, n) {
        if (x.nodeList(e)) return Array.from(e).map(function (e) {
            return z(e, t, n)
        });
        if (x.element(e)) {
            var i = "toggle";
    ...
    var $, G = {
        ...
        Z = {
            ...
            pip: !(_.isIPhone || !x.function(D("video").webkitSetPresentationMode) && (!document.pictureInPictureEnabled || D("video").disablePictureInPicture)),
            ...
            rangeInput: ($ = document.createElement("input"), $.type = "range", "range" === $.type),
    ...
    function re(e) {
        return !!(x.array(e) || x.string(e) && e.includes(":")) && (x.array(e) ? e : e.split(":")).map(Number).every(x.number)
    }
    ...
    function le(e) {
        var t = function (e) {
            ...
            n = t(e);
        if (null === n && (n = t(this.config.ratio)), null === n && !x.empty(this.embed) && x.array(this.embed.ratio) && (n = this.embed.ratio), null === n && this.isHTML5) {
            var i = this.media;
    ...
    var ue = {
        ...
        getQualityOptions: function () {
            return this.config.quality.forced ? this.config.quality.options : ue.getSources.call(this).map(function (e) {
        ...
        setup: function () {
            if (this.isHTML5) {
                var e = this;
                e.options.speed = e.config.speed.options, x.empty(this.config.ratio) || ce.call(e), Object.defineProperty(e.media, "quality", {
                    get: function () {
                    ...
                    set: function (t) {
                        if (e.quality !== t) {
                            if (e.config.quality.forced && x.function(e.config.quality.onChange)) e.config.quality.onChange(t);
                            else {
        ...
        cancelRequests: function () {
            this.isHTML5 && (R(ue.getSources.call(this)), this.media.setAttribute("src", this.config.blankVideo), this.media.load(), this.debug.log("Cancelled network requests"))
        }
    };

    function de(e) {
        return x.array(e) ? e.filter(function (t, n) {
    ...
    function he(e) {
        ...
        return x.empty(e) ? e : e.toString().replace(/{(\d+)}/g, function (e, t) {
            return n[t].toString()
        })
    }
    ...
    function fe() {
        ...
        return (e = function () {
            var e = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "").toString();
            return e = me(e, "-", " "), e = me(e, "_", " "), me(e = pe(e), " ", "")
            ...
            return n(t, [{
                ...
                value: function (e) {
                    if (t.supported && this.enabled && x.object(e)) {
                        var n = this.get();
                        x.empty(n) && (n = {}), j(n, e), window.localStorage.setItem(this.key, JSON.stringify(n))
                    }
                }
            }], [{
                key: "supported",
    ...
    function we(e, t) {
        if (x.string(e)) {
            ...
            if (!n || !i()) {
                ...
                ke(e).then(function (e) {
                    x.empty(e) || (s && window.localStorage.setItem("".concat("cache", "-").concat(t), JSON.stringify({
                        content: e
                    })), a(r, e))
                }).catch(function () {})
            }
    ...
    var Se = {
        getIconUrl: function () {
            var e = new URL(this.config.iconUrl, window.location).host !== window.location.host || _.isIE && !window.svg4everybody;
            return {
        ...
        findElements: function () {
            try {
                return this.elements.controls = X.call(this, this.config.selectors.controls.wrapper), this.elements.buttons = {
                    ...
                    fastForward: X.call(this, this.config.selectors.buttons.fastForward),
                    ...
                    fullscreen: X.call(this, this.config.selectors.buttons.fullscreen)
                }, this.elements.progress = X.call(this, this.config.selectors.progress), this.elements.inputs = {
                    ...
                    currentTime: X.call(this, this.config.selectors.display.currentTime),
                    duration: X.call(this, this.config.selectors.display.duration)
                }, x.element(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector(".".concat(this.config.classNames.tooltip))), !0
            } catch (e) {
        ...
        createButton: function (e, t) {
            ...
            var r = D(s.element);
            return s.toggle ? (r.appendChild(Se.createIcon.call(this, s.iconPressed, {
                class: "icon--pressed"
            })), r.appendChild(Se.createIcon.call(this, s.icon, {
                class: "icon--not-pressed"
            })), r.appendChild(Se.createLabel.call(this, s.labelPressed, {
                class: "label--pressed"
            })), r.appendChild(Se.createLabel.call(this, s.label, {
                class: "label--not-pressed"
            }))) : (r.appendChild(Se.createIcon.call(this, s.icon)), r.appendChild(Se.createLabel.call(this, s.label))), j(i, U(this.config.selectors.buttons[a], i)), H(r, i), "play" === a ? (x.array(this.elements.buttons[a]) || (this.elements.buttons[a] = []), this.elements.buttons[a].push(r)) : this.elements.buttons[a] = r, r
        },
        createRange: function (e, t) {
            var n = D("input", j(U(this.config.selectors.inputs[e]), {
                type: "range",
                min: 0,
                max: 100,
                step: .01,
            ...
            return this.elements.inputs[e] = n, Se.updateRangeFill.call(this, n), w.setup(n), n
        },
        createProgress: function (e, t) {
            var n = D("progress", j(U(this.config.selectors.display[e]), {
                min: 0,
                max: 100,
                value: 0,
                role: "progressbar",
        ...
        bindMenuItemShortcuts: function (e, t) {
            var n = this;
            ne.call(this, e, "keydown keyup", function (i) {
                if ([32, 38, 39, 40].includes(i.which) && (i.preventDefault(), i.stopPropagation(), "keydown" !== i.type)) {
                    var a, s = Y(e, '[role="menuitemradio"]');
                    if (!s && [32, 39].includes(i.which)) Se.showMenuPanel.call(n, t, !0);
                    else 32 !== i.which && (40 === i.which || s && 39 === i.which ? (a = e.nextElementSibling, x.element(a) || (a = e.parentNode.firstElementChild)) : (a = e.previousElementSibling, x.element(a) || (a = e.parentNode.lastElementChild)), J.call(n, a, !0))
                }
            }, !1), ne.call(this, e, "keyup", function (e) {
        ...
        createMenuItem: function (e) {
            var t = this,
                ...
                h = D("span");
            h.innerHTML = s, x.element(o) && h.appendChild(o), d.appendChild(h), Object.defineProperty(d, "checked", {
                enumerable: !0,
                get: function () {
            ...
            }, a, !1), Se.bindMenuItemShortcuts.call(this, d, a), i.appendChild(d)
        },
        formatTime: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
        ...
        updateVolume: function () {
            this.supported.ui && (x.element(this.elements.inputs.volume) && Se.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume), x.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange: function (e) {
        ...
        updateProgress: function (e) {
            ...
            if (this.supported.ui && x.event(e)) {
                ...
                if (e) switch (e.type) {
                    ...
                    case "seeking":
                    case "seeked":
                        n = this.currentTime, i = this.duration, a = 0 === n || 0 === i || Number.isNaN(n) || Number.isNaN(i) ? 0 : (n / i * 100).toFixed(2), "timeupdate" === e.type && Se.setRange.call(this, this.elements.inputs.seek, a);
                        break;
                    case "playing":
                    case "progress":
                        ! function (e, n) {
        ...
        updateRangeFill: function (e) {
            ...
            if (x.element(t) && "range" === t.getAttribute("type")) {
                ...
                _.isWebkit && t.style.setProperty("--value", "".concat(t.value / t.max * 100, "%"))
            }
        },
        updateSeekTooltip: function (e) {
            var t = this;
            if (this.config.tooltips.seek && x.element(this.elements.inputs.seek) && x.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                ...
                if (this.touch) i(!1);
                    ...
                    a < 0 ? a = 0 : a > 100 && (a = 100), Se.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * a), this.elements.display.seekTooltip.style.left = "".concat(a, "%"), x.event(e) && ["mouseenter", "mouseleave"].includes(e.type) && i("mouseenter" === e.type)
                }
            }
        },
        timeUpdate: function (e) {
            var t = !x.element(this.elements.display.duration) && this.config.invertTime;
        ...
        durationUpdate: function () {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                ...
                x.element(this.elements.inputs.seek) && this.elements.inputs.seek.setAttribute("aria-valuemax", this.duration);
        ...
        updateSetting: function (e, t, n) {
            ...
            if ("captions" === e) a = this.currentTrack;
                ...
                if (a = x.empty(n) ? this[e] : n, x.empty(a) && (a = this.config[e].default), !x.empty(this.options[e]) && !this.options[e].includes(a)) return void this.debug.warn("Unsupported value of '".concat(a, "' for ").concat(e));
                if (!this.config[e].options.includes(a)) return void this.debug.warn("Disabled value of '".concat(a, "' for ").concat(e))
            }
            if (x.element(s) || (s = i && i.querySelector('[role="menu"]')), x.element(s)) {
                this.elements.settings.buttons[e].querySelector(".".concat(this.config.classNames.menu.value)).innerHTML = Se.getLabel.call(this, e, a);
        ...
        getLabel: function (e, t) {
            switch (e) {
                case "speed":
                    return 1 === t ? ve("normal", this.config) : "".concat(t, "&times;");
                case "quality":
                    if (x.number(t)) {
        ...
        setQualityMenu: function (e) {
            ...
            if (x.element(this.elements.settings.panels.quality)) {
                ...
                x.array(e) && (this.options.quality = de(e).filter(function (e) {
                    return t.config.quality.options.includes(e)
                }));
                var i = !x.empty(this.options.quality) && this.options.quality.length > 1;
                if (Se.toggleMenuButton.call(this, "quality", i), V(n), Se.checkMenu.call(this), i) {
                    var a = function (e) {
        ...
        setCaptionsMenu: function () {
            ...
            if (x.element(this.elements.settings.panels.captions)) {
                var t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
                    ...
                    i = Boolean(n.length);
                if (Se.toggleMenuButton.call(this, "captions", i), V(t), Se.checkMenu.call(this), i) {
                    ...
                    a.unshift({
                        ...
                        list: t,
                        type: "language"
                    }), a.forEach(Se.createMenuItem.bind(this)), Se.updateSetting.call(this, "captions", t)
                }
            }
        },
        setSpeedMenu: function () {
            ...
            if (x.element(this.elements.settings.panels.speed)) {
                ...
                Se.toggleMenuButton.call(this, "speed", n), V(t), Se.checkMenu.call(this), n && (this.options.speed.forEach(function (n) {
        ...
        checkMenu: function () {
            var e = this.elements.settings.buttons,
                t = !x.empty(e) && Object.values(e).some(function (e) {
                    return !e.hidden
                });
        ...
        focusFirstMenuItem: function (e) {
            ...
            if (!this.elements.settings.popup.hidden) {
                var n = e;
                x.element(n) || (n = Object.values(this.elements.settings.panels).find(function (e) {
                    return !e.hidden
                }));
        ...
        toggleMenu: function (e) {
            ...
            if (x.element(t) && x.element(n)) {
                ...
                n.setAttribute("aria-expanded", a), W(t, !a), z(this.elements.container, this.config.classNames.menu.open, a), a && x.keyboardEvent(e) ? Se.focusFirstMenuItem.call(this, null, !0) : a || i || J.call(this, n, x.keyboardEvent(e))
            }
        },
            ...
            if (x.element(i)) {
                ...
                if (Z.transitions && !Z.reducedMotion) {
                    ...
                    ne.call(this, a, L, function t(n) {
                        n.target === a && ["width", "height"].includes(n.propertyName) && (a.style.width = "", a.style.height = "", ie.call(e, a, L, t))
        ...
        create: function (e) {
            ...
            return de(this.config.controls).forEach(function (o) {
                ...
                if ("current-time" === o && u.appendChild(r.call(t, "currentTime", d)), "duration" === o && u.appendChild(r.call(t, "duration", d)), "mute" === o || "volume" === o) {
                    ...
                    if (x.element(p) && u.contains(p) || (p = D("div", j({}, d, {
                            class: "".concat(d.class, " plyr__volume").trim()
                        })), t.elements.volume = p, u.appendChild(p)), "mute" === o && p.appendChild(i.call(t, "mute")), "volume" === o && !_.isIos) {
                        var f = {
                            max: 1,
                            step: .05,
                            value: t.config.volume
                        };
                        p.appendChild(s.call(t, "volume", j(f, {
                            id: "plyr-volume-".concat(e.id)
                        })))
                    }
                }
                if ("captions" === o && u.appendChild(i.call(t, "captions", d)), "settings" === o && !x.empty(t.config.settings)) {
                    var g = D("div", j({}, d, {
                    ...
                    b.appendChild(k), v.appendChild(b), t.elements.settings.panels.home = b, t.config.settings.forEach(function (i) {
                        var a = D("button", j(U(t.config.selectors.buttons.settings), {
                            type: "button",
                        ...
                        n.call(t, a, i), ne.call(t, a, "click", function () {
                            c.call(t, i, !1)
                        });
                        ...
                        l.appendChild(D("span", {
                            "aria-hidden": !0
                        }, ve(i, t.config))), l.appendChild(D("span", {
                            class: t.config.classNames.hidden
                        }, ve("menuBack", t.config))), ne.call(t, o, "keydown", function (e) {
                            37 === e.which && (e.preventDefault(), e.stopPropagation(), c.call(t, "home", !0))
                        }, !1), ne.call(t, l, "click", function () {
                            c.call(t, "home", !1)
                        }), o.appendChild(l), o.appendChild(D("div", {
                            role: "menu"
                ...
                if ("pip" === o && Z.pip && u.appendChild(i.call(t, "pip", d)), "airplay" === o && Z.airplay && u.appendChild(i.call(t, "airplay", d)), "download" === o) {
                    var w = j({}, d, {
                        element: "a",
                        href: t.download,
                        target: "_blank"
                    ...
                    !x.url(T) && t.isEmbed && j(w, {
                        icon: "logo-".concat(t.provider),
                        label: t.provider
                    }), u.appendChild(i.call(t, "download", w))
                }
                "fullscreen" === o && u.appendChild(i.call(t, "fullscreen", d))
            }), this.isHTML5 && o.call(this, ue.getQualityOptions.call(this)), l.call(this), u
        },
        inject: function () {
            var e = this;
            ...
            var i = {
                ...
                a = !0;
            x.function(this.config.controls) && (this.config.controls = this.config.controls.call(this, i)), this.config.controls || (this.config.controls = []), x.element(this.config.controls) || x.string(this.config.controls) ? n = this.config.controls : (n = Se.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            if (a && (x.string(this.config.controls) ? n = o(n) : x.element(n) && (n.innerHTML = o(n.innerHTML))), x.string(this.config.selectors.controls.container) && (s = document.querySelector(this.config.selectors.controls.container)), x.element(s) || (s = this.elements.container), s[x.element(n) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", n), x.element(this.elements.controls) || Se.findElements.call(this), !x.empty(this.elements.buttons)) {
                var l = function (t) {
                ...
                Object.values(this.elements.buttons).filter(Boolean).forEach(function (e) {
                    x.array(e) || x.nodeList(e) ? Array.from(e).filter(Boolean).forEach(l) : l(e)
                })
            }
            if (_.isEdge && I(s), this.config.tooltips.controls) {
                ...
                Array.from(m).forEach(function (t) {
                    z(t, e.config.classNames.hidden, !1), z(t, e.config.classNames.tooltip, !0)
                })
            }
        }
    };
    ...
    function Ne(e) {
        ...
        return x.object(e) && Object.entries(e).forEach(function (e) {
            var n = r(e, 2),
                i = n[0],
                a = n[1];
            t.set(i, a)
    ...
    var Me = {
            setup: function () {
                if (this.supported.ui)
                    if (!this.isVideo || this.isYouTube || this.isHTML5 && !Z.textTracks) x.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Se.setCaptionsMenu.call(this);
                    else {
                        var e, t;
                        if (x.element(this.elements.captions) || (this.elements.captions = D("div", U(this.config.selectors.captions)), e = this.elements.captions, t = this.elements.wrapper, x.element(e) && x.element(t) && t.parentNode.insertBefore(e, t.nextSibling)), _.isIE && window.URL) {
                            var n = this.media.querySelectorAll("track");
                            Array.from(n).forEach(function (e) {
                                var t = e.getAttribute("src"),
                                    n = Pe(t);
                                null !== n && n.hostname !== window.location.href.hostname && ["http:", "https:"].includes(n.protocol) && ke(t, "blob").then(function (t) {
                        ...
                        var i = de((navigator.languages || [navigator.language || navigator.userLanguage || "en"]).map(function (e) {
                                return e.split("-")[0]
                            })),
                            a = (this.storage.get("language") || this.config.captions.language || "auto").toLowerCase();
                        if ("auto" === a) a = r(i, 1)[0];
                        var s = this.storage.get("captions");
                        if (x.boolean(s) || (s = this.config.captions.active), Object.assign(this.captions, {
                                toggled: !1,
                                active: s,
                                language: a,
                                languages: i
            ...
            update: function () {
                ...
                this.isHTML5 && this.isVideo && t.filter(function (e) {
                    ...
                    }), t.mode = "hidden", ne.call(e, t, "cuechange", function () {
                        return Me.updateCues.call(e)
                    })
                }), (o && this.language !== a || !t.includes(r)) && (Me.setLanguage.call(this, a), Me.toggle.call(this, i && o)), z(this.elements.container, this.config.classNames.captions.enabled, !x.empty(t)), (this.config.controls || []).includes("settings") && this.config.settings.includes("captions") && Se.setCaptionsMenu.call(this)
            },
            toggle: function (e) {
                var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                if (this.supported.ui) {
                    ...
                    if (a !== n) {
                        if (t || (this.captions.active = a, this.storage.set({
                            ...
                            var s = Me.getTracks.call(this),
                                r = Me.findTrack.call(this, [this.captions.language].concat(o(this.captions.languages)), !0);
                            return this.captions.language = r.language, void Me.set.call(this, s.indexOf(r))
                        }
                        this.elements.buttons.captions && (this.elements.buttons.captions.pressed = a), z(this.elements.container, i, a), this.captions.toggled = a, Se.updateSetting.call(this, "captions"), se.call(this, this.media, a ? "captionsenabled" : "captionsdisabled")
                    }
                }
            },
            set: function (e) {
                    ...
                    if (x.number(e))
                        if (e in n) {
                            if (this.captions.currentTrack !== e) {
                                ...
                                var i = n[e],
                                    a = (i || {}).language;
                                this.captions.currentTrackNode = i, Se.updateSetting.call(this, "captions"), t || (this.captions.language = a, this.storage.set({
                                    language: a
                                })), this.isVimeo && this.embed.enableTextTrack(a), se.call(this, this.media, "languagechange")
                            }
                            Me.toggle.call(this, !0, t), this.isHTML5 && this.isVideo && Me.updateCues.call(this)
            ...
            getLabel: function (e) {
                var t = e;
                return !x.track(t) && Z.textTracks && this.captions.toggled && (t = Me.getCurrentTrack.call(this)), x.track(t) ? x.empty(t.label) ? x.empty(t.language) ? ve("enabled", this.config) : e.language.toUpperCase() : t.label : ve("disabled", this.config)
            },
                    ...
                    if (x.element(this.elements.captions))
                        if (x.nullOrUndefined(e) || Array.isArray(e)) {
                            ...
                            if (i !== this.elements.captions.innerHTML) {
                                ...
                                a.innerHTML = i, this.elements.captions.appendChild(a), se.call(this, this.media, "cuechange")
                            }
        ...
        He = function () {
            function t(n) {
                ...
                e(this, t), this.player = n, this.prefix = t.prefix, this.property = t.property, this.scrollPosition = {
                    x: 0,
                    y: 0
                }, this.forceFallback = "force" === n.config.fullscreen.fallback, ne.call(this.player, document, "ms" === this.prefix ? "MSFullscreenChange" : "".concat(this.prefix, "fullscreenchange"), function () {
                    i.onChange()
                }), ne.call(this.player, this.player.elements.container, "dblclick", function (e) {
                    x.element(i.player.elements.controls) && i.player.elements.controls.contains(e.target) || i.toggle()
                }), ne.call(this, this.player.elements.container, "keydown", function (e) {
            ...
            return n(t, [{
                ...
                value: function () {
                    if (this.enabled) {
                        ...
                        x.element(e) && (e.pressed = this.active), se.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0)
                    }
                }
            }, {
                key: "toggleFallback",
                value: function () {
                    ...
                    if (e ? this.scrollPosition = {
                            x: window.scrollX || 0,
                            y: window.scrollY || 0
                        } : window.scrollTo(this.scrollPosition.x, this.scrollPosition.y), document.body.style.overflowY = e ? "hidden" : "", z(this.target, this.player.config.classNames.fullscreen.fallback, e), _.isIos) {
                ...
                key: "trapFocus",
                value: function (e) {
                    if (!_.isIos && this.active && "Tab" === e.key && 9 === e.keyCode) {
                        var t = document.activeElement,
                            n = Q.call(this.player, "a[href], button:not(:disabled), input:not(:disabled), [tabindex]"),
                            i = r(n, 1)[0],
                            a = n[n.length - 1];
                ...
                value: function () {
                    ...
                    z(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.enabled)
                }
            }, {
                key: "enter",
                value: function () {
                    this.enabled && (_.isIos && this.player.config.fullscreen.iosNative ? this.target.webkitEnterFullscreen() : !t.native || this.forceFallback ? this.toggleFallback(!0) : this.prefix ? x.empty(this.prefix) || this.target["".concat(this.prefix, "Request").concat(this.property)]() : this.target.requestFullscreen({
                        navigationUI: "hide"
                    }))
                }
            }, {
                ...
                value: function () {
                    if (this.enabled)
                        if (_.isIos && this.player.config.fullscreen.iosNative) this.target.webkitExitFullscreen(), this.player.play();
                ...
                key: "target",
                get: function () {
                    return _.isIos && this.player.config.fullscreen.iosNative ? this.player.media : this.player.elements.container
                }
            }], [{
                key: "native",
                get: function () {
                ...
                get: function () {
                    ...
                    return ["webkit", "moz", "ms"].some(function (t) {
                        return !(!x.function(document["".concat(t, "ExitFullscreen")]) && !x.function(document["".concat(t, "CancelFullScreen")])) && (e = t, !0)
                    }), e
                }
            }, {
                key: "property",
    ...
    var Fe = {
            addStyleHook: function () {
                z(this.elements.container, this.config.selectors.container.replace(".", ""), !0), z(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
            },
            ...
            build: function () {
                ...
                x.element(this.elements.controls) || (Se.inject.call(this), this.listeners.controls()), Fe.toggleNativeControls.call(this), this.isHTML5 && Me.setup.call(this), this.volume = null, this.muted = null, this.loop = null, this.quality = null, this.speed = null, Se.updateVolume.call(this), Se.timeUpdate.call(this), Fe.checkPlaying.call(this), z(this.elements.container, this.config.classNames.pip.supported, Z.pip && this.isHTML5 && this.isVideo), z(this.elements.container, this.config.classNames.airplay.supported, Z.airplay && this.isHTML5), z(this.elements.container, this.config.classNames.isIos, _.isIos), z(this.elements.container, this.config.classNames.isTouch, this.touch), this.ready = !0, setTimeout(function () {
                    se.call(e, e.media, "ready")
                }, 0), Fe.setTitle.call(this), this.poster && Fe.setPoster.call(this, this.poster, !1).catch(function () {}), this.config.duration && Se.durationUpdate.call(this)
            },
            setTitle: function () {
                var e = ve("play", this.config);
                if (x.string(this.config.title) && !x.empty(this.config.title) && (e += ", ".concat(this.config.title)), Array.from(this.elements.buttons.play || []).forEach(function (t) {
            ...
            setPoster: function (e) {
                var t = this;
                return arguments.length > 1 && void 0 !== arguments[1] && !arguments[1] || !this.poster ? (this.media.setAttribute("poster", e), this.isHTML5 ? Promise.resolve(e) : function () {
                    var e = this;
                    return new Promise(function (t) {
                        return e.ready ? setTimeout(t, 0) : ne.call(e, e.elements.container, "ready", t)
                    }).then(function () {})
            ...
            checkPlaying: function (e) {
                var t = this;
                z(this.elements.container, this.config.classNames.playing, this.playing), z(this.elements.container, this.config.classNames.paused, this.paused), z(this.elements.container, this.config.classNames.stopped, this.stopped), Array.from(this.elements.buttons.play || []).forEach(function (e) {
                    Object.assign(e, {
                        pressed: t.playing
                    }), e.setAttribute("aria-label", ve(t.playing ? "pause" : "play", t.config))
                }), x.event(e) && "timeupdate" === e.type || Fe.toggleControls.call(this)
            },
            checkLoading: function (e) {
                var t = this;
                this.loading = ["stalled", "waiting"].includes(e.type), clearTimeout(this.timers.loading), this.timers.loading = setTimeout(function () {
                    z(t.elements.container, t.config.classNames.loading, t.loading), Fe.toggleControls.call(t)
                }, this.loading ? 250 : 0)
            },
            ...
            return n(t, [{
                ...
                value: function (e) {
                    var t = this.player,
                        ...
                        a = "keydown" === e.type,
                        s = a && i === this.lastKey;
                    if (!(e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) && x.number(i)) {
                        if (a) {
                            var r = document.activeElement;
                            if (x.element(r)) {
                                var o = t.config.selectors.editable;
                                if (r !== n.inputs.seek && Y(r, o)) return;
                                if (32 === e.which && Y(r, 'button, [role^="menuitem"]')) return
                            }
                ...
                value: function (e) {
                    ...
                    if (clearTimeout(this.focusTimer), "keydown" !== e.type || 9 === e.which) {
                        ...
                        if ("focus" !== e.type || a) i = t.config.classNames.tabFocus, z(Q.call(t, ".".concat(i)), i, !1), this.focusTimer = setTimeout(function () {
                            var e = document.activeElement;
                            n.container.contains(e) && z(document.activeElement, t.config.classNames.tabFocus, !0)
                        }, 10)
                    }
                }
            }, {
                ...
                value: function () {
                    var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
                        t = this.player;
                    t.config.keyboard.global && te.call(t, window, "keydown keyup", this.handleKey, e, !1), te.call(t, document.body, "click", this.toggleMenu, e), ae.call(t, document.body, "touchstart", this.firstTouch), te.call(t, document.body, "keydown focus blur", this.setTabFocus, e, !1, !0)
                }
            }, {
                key: "container",
                value: function () {
                    var e = this.player,
                        ...
                        n = e.elements,
                        i = e.timers;
                    !t.keyboard.global && t.keyboard.focused && ne.call(e, n.container, "keydown keyup", this.handleKey, !1), ne.call(e, n.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", function (t) {
                        var a = n.controls;
                    ...
                    ne.call(e, n.container, "enterfullscreen exitfullscreen", function (t) {
                        var i = e.fullscreen,
                            o = i.target,
                            l = i.usingNative;
                        if (o === n.container && (e.isEmbed || !x.empty(e.config.ratio))) {
                            ...
                            ! function (t, n, i) {
                                if (e.isVimeo) {
                                    var a = e.elements.wrapper.firstChild,
                                        ...
                                        l = o[0],
                                        c = o[1];
                                    a.style.maxWidth = i ? "".concat(s / c * l, "px") : null, a.style.margin = i ? "0 auto" : null
                                }
                            }(u.ratio, 0, c), l || (c ? ne.call(e, window, "resize", s) : ie.call(e, window, "resize", s))
                        }
                    })
                }
            }, {
                ...
                value: function () {
                    var e = this,
                        t = this.player,
                        n = t.elements;
                    if (ne.call(t, t.media, "timeupdate seeking seeked", function (e) {
                            return Se.timeUpdate.call(t, e)
                        }), ne.call(t, t.media, "durationchange loadeddata loadedmetadata", function (e) {
                            return Se.durationUpdate.call(t, e)
                        }), ne.call(t, t.media, "ended", function () {
                            t.isHTML5 && t.isVideo && t.config.resetOnEnd && (t.restart(), t.pause())
                        }), ne.call(t, t.media, "progress playing seeking seeked", function (e) {
                            return Se.updateProgress.call(t, e)
                        }), ne.call(t, t.media, "volumechange", function (e) {
                            return Se.updateVolume.call(t, e)
                        }), ne.call(t, t.media, "playing play pause ended emptied timeupdate", function (e) {
                            return Fe.checkPlaying.call(t, e)
                        }), ne.call(t, t.media, "waiting canplay seeked playing", function (e) {
                    ...
                    t.supported.ui && t.config.disableContextMenu && ne.call(t, n.wrapper, "contextmenu", function (e) {
                        e.preventDefault()
                    }, !1), ne.call(t, t.media, "volumechange", function () {
                        t.storage.set({
                            volume: t.volume,
                            muted: t.muted
                        })
                    }), ne.call(t, t.media, "ratechange", function () {
                        Se.updateSetting.call(t, "speed"), t.storage.set({
                            speed: t.speed
                        })
                    ...
                    ne.call(t, t.media, a, function (e) {
                        var i = e.detail,
                            a = void 0 === i ? {} : i;
                        "error" === e.type && (a = t.media.error), se.call(t, n.container, e.type, !0, a)
                    })
                }
            }, {
                key: "proxy",
                value: function (e, t, n) {
                    var i = this.player,
                        ...
                        s = !0;
                    x.function(a) && (s = a.call(i, e)), !1 !== s && x.function(t) && t.call(i, e)
                }
            }, {
                key: "bind",
                ...
                value: function () {
                    ...
                    if (n.buttons.play && Array.from(n.buttons.play).forEach(function (n) {
                            ...
                            e.stopPropagation(), e.preventDefault(), Se.toggleMenu.call(t, e)
                    ...
                    this.bind(n.inputs.seek, i, function (e) {
                        ...
                        x.empty(i) && (i = n.value), n.removeAttribute("seek-value"), t.currentTime = i / n.max * t.duration
                    ...
                    }), _.isWebkit && Array.from(Q.call(t, 'input[type="range"]')).forEach(function (n) {
                        e.bind(n, "input", function (e) {
                            return Se.updateRangeFill.call(t, e.target)
                        })
                    }), t.config.toggleInvert && !x.element(n.display.duration) && this.bind(n.display.currentTime, "click", function () {
                        ...
                        var i = t.config,
                            a = t.timers;
                        z(n.controls, i.classNames.noTransition, !0), Fe.toggleControls.call(t, !0), setTimeout(function () {
        ...
        e.exports = function () {
            ...
            function r(t, n, i, a) {
                var s, o, l = document,
                    ...
                    h = t.replace(/[\?|#].*$/, ""),
                    m = t.replace(/^(css|img)!/, "");
                a = a || 0, /(^css!|\.css$)/.test(h) ? ((o = l.createElement("link")).rel = "stylesheet", o.href = m, (s = "hideFocus" in o) && o.relList && (s = 0, o.rel = "preload", o.as = "style")) : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(h) ? (o = l.createElement("img")).src = m : ((o = l.createElement("script")).src = t, o.async = void 0 === c || c), o.onload = o.onerror = o.onbeforeload = function (e) {
                    var l = e.type[0];
                    if (s) try {
    ...
    var ze = {
        setup: function () {
            var e = this;
            z(e.elements.wrapper, e.config.classNames.embed, !0), e.options.speed = e.config.speed.options, ce.call(e), x.object(window.Vimeo) ? ze.ready.call(e) : Ue(e.config.urls.vimeo.sdk).then(function () {
                ze.ready.call(e)
            }).catch(function (t) {
        ...
        ready: function () {
            ...
            var s, o = (s = a, x.empty(s) ? null : x.number(Number(s)) ? s : s.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : s),
                l = D("iframe"),
                c = he(t.config.urls.vimeo.iframe, o, i);
            l.setAttribute("src", c), l.setAttribute("allowfullscreen", ""), l.setAttribute("allowtransparency", ""), l.setAttribute("allow", "autoplay"), x.empty(n.referrerPolicy) || l.setAttribute("referrerPolicy", n.referrerPolicy);
            var u = D("div", {
                poster: t.poster,
                class: t.config.classNames.embedContainer
            });
            u.appendChild(l), t.media = B(u, t.media), ke(he(t.config.urls.vimeo.api, o), "json").then(function (e) {
                if (!x.empty(e)) {
            ...
            Object.defineProperty(t.media, "currentTime", {
                ...
                set: function (e) {
                    var n = t.embed,
                        ...
                        s = t.volume,
                        r = a && !n.hasPlayed;
                    i.seeking = !0, se.call(t, i, "seeking"), Promise.resolve(r && n.setVolume(0)).then(function () {
            ...
            Object.defineProperty(t.media, "loop", {
                ...
                }), x.element(t.embed.element) && t.supported.ui) && t.embed.element.setAttribute("tabindex", -1)
                ...
                t.media.seeking = !1, d = e.seconds, se.call(t, t.media, "timeupdate")
    ...
    var Qe = {
            setup: function () {
                var e = this;
                if (z(this.elements.wrapper, this.config.classNames.embed, !0), x.object(window.YT) && x.function(window.YT.Player)) Qe.ready.call(this);
                else {
            ...
            getTitle: function (e) {
                var t = this;
                ke(he(this.config.urls.youtube.api, e)).then(function (e) {
                    if (x.object(e)) {
                        var n = e.title,
                            i = e.height,
                            a = e.width;
            ...
            ready: function () {
                ...
                if (x.empty(t) || !t.startsWith("youtube-")) {
                    ...
                    x.empty(n) && (n = e.media.getAttribute(this.config.attributes.embed.id));
                    var i, a, s = (i = n, x.empty(i) ? null : i.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : i),
                    ...
                    e.embed = new window.YT.Player(r, {
                        ...
                        events: {
                            ...
                            onPlaybackRateChange: function (t) {
                                var n = t.target;
                                e.media.playbackRate = n.getPlaybackRate(), se.call(e, e.media, "ratechange")
                            },
                            onReady: function (t) {
                                if (!x.function(e.media.play)) {
                                    ...
                                    Qe.getTitle.call(e, s), e.media.play = function () {
                                        ...
                                        set: function (t) {
                                            e.paused && !e.embed.hasPlayed && e.embed.mute(), e.media.seeking = !0, se.call(e, e.media, "seeking"), n.seekTo(t)
                                        }
                                    ...
                                    Object.defineProperty(e.media, "volume", {
                                        ...
                                        set: function (t) {
                                            i = t, n.setVolume(100 * i), se.call(e, e.media, "volumechange")
                                        }
                                    });
                                    ...
                                    Object.defineProperty(e.media, "muted", {
                                        ...
                                        set: function (t) {
                                            ...
                                            a = i, n[i ? "mute" : "unMute"](), se.call(e, e.media, "volumechange")
                                        }
                                    ...
                                    e.options.speed = r.filter(function (t) {
                                        ...
                                        e.media.buffered = n.getVideoLoadedFraction(), (null === e.media.lastBuffered || e.media.lastBuffered < e.media.buffered) && se.call(e, e.media, "progress"), e.media.lastBuffered = e.media.buffered, 1 === e.media.buffered && (clearInterval(e.timers.buffering), se.call(e, e.media, "canplaythrough"))
                            ...
                            onStateChange: function (t) {
                                ...
                                switch (clearInterval(e.timers.playing), e.media.seeking && [1, 2].includes(t.data) && (e.media.seeking = !1, se.call(e, e.media, "seeked")), t.data) {
                                    case -1:
                                        se.call(e, e.media, "timeupdate"), e.media.buffered = n.getVideoLoadedFraction(), se.call(e, e.media, "progress");
                                        break;
                                    case 0:
                                        Ke.call(e, !1), e.media.loop ? (n.stopVideo(), n.playVideo()) : se.call(e, e.media, "ended");
                                        break;
                                    case 1:
                                        e.config.autoplay || !e.media.paused || e.embed.hasPlayed ? (Ke.call(e, !0), se.call(e, e.media, "playing"), e.timers.playing = setInterval(function () {
                                            se.call(e, e.media, "timeupdate")
                                        }, 50), e.media.duration !== n.getDuration() && (e.media.duration = n.getDuration(), se.call(e, e.media, "durationchange"))) : e.media.pause();
                                        break;
                                    case 2:
        ...
        Xe = {
            setup: function () {
                this.media ? (z(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0), z(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0), this.isEmbed && z(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0), this.isVideo && (this.elements.wrapper = D("div", {
                    class: this.config.classNames.video
                }), q(this.media, this.elements.wrapper), this.isEmbed && (this.elements.poster = D("div", {
                    class: this.config.classNames.poster
                }), this.elements.wrapper.appendChild(this.elements.poster))), this.isHTML5 ? ue.setup.call(this) : this.isYouTube ? Qe.setup.call(this) : this.isVimeo && ze.setup.call(this)) : this.debug.warn("No media element found!")
            }
        },
        Je = function () {
            function t(n) {
            ...
            return n(t, [{
                ...
                value: function () {
                    var e = this;
                    this.enabled && (x.object(window.google) && x.object(window.google.ima) ? this.ready() : Ue(this.player.config.urls.googleIMA.sdk).then(function () {
                        e.ready()
                    }).catch(function () {
                ...
                value: function () {
                    ...
                    this.countdownTimer = setInterval(function () {
                        var t = Ee(Math.max(e.manager.getRemainingTime(), 0)),
                            n = "".concat(ve("advertisement", e.player.config), " - ").concat(t);
                ...
                value: function () {
                    var e = this;
                    x.empty(this.cuePoints) || this.cuePoints.forEach(function (t) {
                ...
                value: function (e) {
                    var t, n = this,
                        ...
                        a = e.getAd(),
                        s = e.getAdData();
                    switch (t = e.type, se.call(n.player, n.player.media, "ads".concat(t.replace(/_/g, "").toLowerCase())), e.type) {
                        case google.ima.AdEvent.Type.LOADED:
                            this.trigger("loaded"), this.pollCountdown(!0), a.isLinear() || (a.width = i.offsetWidth, a.height = i.offsetHeight);
                            break;
                ...
                value: function () {
                    ...
                    this.player.on("canplay", function () {
                        ...
                        x.empty(t.cuePoints) || t.cuePoints.forEach(function (i, a) {
                ...
                value: function (e) {
                    ...
                    var s = this.events[e];
                    x.array(s) && s.forEach(function (e) {
                ...
                key: "on",
                value: function (e, t) {
                    return x.array(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this
                }
            }, {
                ...
                value: function (e) {
                    x.nullOrUndefined(this.safetyTimer) || (this.player.debug.log("Safety timer cleared from: ".concat(e)), clearTimeout(this.safetyTimer), this.safetyTimer = null)
                }
            }, {
                key: "enabled",
                get: function () {
                    var e = this.config;
                    return this.player.isHTML5 && this.player.isVideo && e.enabled && (!x.empty(e.publisherId) || x.url(e.tagUrl))
                }
            }, {
                key: "tagUrl",
                get: function () {
                    ...
                    return "".concat("https://go.aniview.com/api/adserver6/vast/", "?").concat(Ne(t))
                }
            }]), t
        }(),
        $e = function (e, t) {
            ...
            return n(t, [{
                ...
                value: function () {
                    ...
                    return new Promise(function (t) {
                        ...
                        if (x.empty(n)) throw new Error("Missing previewThumbnails.src config attribute");
                ...
                key: "startMove",
                value: function (e) {
                    if (this.loaded && x.event(e) && ["touchmove", "mousemove"].includes(e.type) && this.player.media.duration) {
                ...
                key: "startScrubbing",
                value: function (e) {
                    (x.nullOrUndefined(e.button) || !1 === e.button || 0 === e.button) && (this.mouseDown = !0, this.player.media.duration && (this.toggleScrubbingContainer(!0), this.toggleThumbContainer(!1, !0), this.showImageAtCurrentTime()))
                }
            }, {
                key: "endScrubbing",
                value: function () {
                    var e = this;
                    this.mouseDown = !1, Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime) ? this.toggleScrubbingContainer(!1) : ae.call(this.player, this.player.media, "timeupdate", function () {
                ...
                value: function () {
                    ...
                    this.elements.thumb.time = D("span", {}, "00:00"), e.appendChild(this.elements.thumb.time), this.elements.thumb.container.appendChild(e), x.element(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container), this.elements.scrubbing.container = D("div", {
                ...
                get: function () {
                    return this.mouseDown ? $e(this.thumbAspectRatio, {
                        width: this.player.media.clientWidth,
                        height: this.player.media.clientHeight
        ...
        Ze = {
            insertElements: function (e, t) {
                var n = this;
                x.string(t) ? F(e, this.media, {
                    src: t
                }) : x.array(t) && t.forEach(function (t) {
                    F(e, n.media, t)
                })
            },
            change: function (e) {
                var t = this;
                O(e, "sources.length") ? (ue.cancelRequests.call(this), this.destroy.call(this, function () {
                    t.options.quality = [], R(t.media), t.media = null, x.element(t.elements.container) && t.elements.container.removeAttribute("class");
                    var n = e.sources,
                        i = e.type,
                        a = r(n, 1)[0],
                        s = a.provider,
    ...
    var et, tt = function () {
        function t(n, i) {
            var a = this;
            if (e(this, t), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = Z.touch, this.media = n, x.string(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || x.nodeList(this.media) || x.array(this.media)) && (this.media = this.media[0]), this.config = j({}, xe, t.defaults, i || {}, function () {
                    try {
                    ...
                    speed: [],
                    quality: []
                }, this.debug = new qe(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", Z), !x.nullOrUndefined(this.media) && x.element(this.media))
                ...
                if (Z.check().api) {
                    ...
                    switch (r) {
                        case "div":
                            if (o = this.media.querySelector("iframe"), x.element(o)) {
                                if (l = Pe(o.getAttribute("src")), this.provider = function (e) {
                            ...
                            if (x.empty(this.provider) || !Object.keys(_e).includes(this.provider)) return void this.debug.error("Setup failed: Invalid provider");
                            this.type = Oe.video;
                            break;
                        case "video":
                        case "audio":
                            this.type = r, this.provider = _e.html5, this.media.hasAttribute("crossorigin") && (this.config.crossorigin = !0), this.media.hasAttribute("autoplay") && (this.config.autoplay = !0), (this.media.hasAttribute("playsinline") || this.media.hasAttribute("webkit-playsinline")) && (this.config.playsinline = !0), this.media.hasAttribute("muted") && (this.config.muted = !0), this.media.hasAttribute("loop") && (this.config.loop.active = !0);
                            break;
                        default:
                            return void this.debug.error("Setup failed: unsupported type")
                    }
                    this.supported = Z.check(this.type, this.provider, this.config.playsinline), this.supported.api ? (this.eventListeners = [], this.listeners = new Re(this), this.storage = new be(this), this.media.plyr = this, x.element(this.elements.container) || (this.elements.container = D("div", {
                        tabindex: 0
                    }), q(this.media, this.elements.container)), Fe.addStyleHook.call(this), Xe.setup.call(this), this.config.debug && ne.call(this, this.elements.container, this.config.events.join(" "), function (e) {
                        ...
                        return a.play()
                    }, 10), this.lastSeekTime = 0, this.config.previewThumbnails.enabled && (this.previewThumbnails = new Ge(this))) : this.debug.error("Setup failed: no support")
        ...
        return n(t, [{
            ...
            value: function () {
                var e = this;
                return x.function(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(function () {
                    return e.ads.play()
                }).catch(function () {
                    return e.media.play()
            ...
            key: "pause",
            value: function () {
                return this.playing && x.function(this.media.pause) ? this.media.pause() : null
            }
        }, {
            key: "togglePlay",
            value: function (e) {
                return (x.boolean(e) ? e : !this.playing) ? this.play() : this.pause()
            }
        }, {
            key: "stop",
            value: function () {
                this.isHTML5 ? (this.pause(), this.restart()) : x.function(this.media.stop) && this.media.stop()
            }
        }, {
            key: "restart",
            value: function () {
            ...
            value: function (e) {
                if (this.supported.ui && !this.isAudio) {
                    var t = K(this.elements.container, this.config.classNames.hideControls),
                        n = void 0 === e ? void 0 : !e,
                        i = z(this.elements.container, this.config.classNames.hideControls, n);
                    if (i && this.config.controls.includes("settings") && !x.empty(this.config.settings) && Se.toggleMenu.call(this, !1), i !== t) {
            ...
            value: function (e) {
                ...
                if (this.ready) {
                    var i = function () {
                        document.body.style.overflow = "", t.embed = null, n ? (Object.keys(t.elements).length && (R(t.elements.buttons.play), R(t.elements.captions), R(t.elements.controls), R(t.elements.wrapper), t.elements.buttons.play = null, t.elements.captions = null, t.elements.controls = null, t.elements.wrapper = null), x.function(e) && e()) : (function () {
                        ...
                        }.call(t), B(t.elements.original, t.elements.container), se.call(t, t.elements.original, "destroyed", !0), x.function(e) && e.call(t.elements.original), t.ready = !1, setTimeout(function () {
            ...
            get: function () {
                ...
                return x.number(e) ? e : e && e.length && this.duration > 0 ? e.end(0) / this.duration : 0
            }
        }, {
            key: "seeking",
            get: function () {
            ...
            set: function (e) {
                var t = e;
                x.string(t) && (t = Number(t)), x.number(t) || (t = this.storage.get("volume")), x.number(t) || (t = this.config.volume), t > 1 && (t = 1), t < 0 && (t = 0), this.config.volume = t, this.media.volume = t, !x.empty(e) && this.muted && t > 0 && (this.muted = !1)
            },
            get: function () {
            ...
            set: function (e) {
                var t = e;
                x.boolean(t) || (t = this.storage.get("muted")), x.boolean(t) || (t = this.config.muted), this.config.muted = t, this.media.muted = t
            },
            get: function () {
            ...
            set: function (e) {
                var t = this,
                    n = null;
                x.number(e) && (n = e), x.number(n) || (n = this.storage.get("speed")), x.number(n) || (n = this.config.speed.selected);
            ...
            set: function (e) {
                ...
                if (n.length) {
                    var i = [!x.empty(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(x.number),
                        a = !0;
                    if (!n.includes(i)) {
                        var s = function (e, t) {
                            return x.array(e) && e.length ? e.reduce(function (e, n) {
            ...
            set: function (e) {
                x.url(e) && (this.config.urls.download = e, Se.setDownloadUrl.call(this))
            }
        }, {
            key: "poster",
            set: function (e) {
            ...
            set: function (e) {
                this.isVideo ? x.string(e) && re(e) ? (this.config.ratio = e, ce.call(this)) : this.debug.error("Invalid aspect ratio specified (".concat(e, ")")) : this.debug.warn("Aspect ratio can only be set for video")
            }
        }, {
            key: "autoplay",
            set: function (e) {
            ...
            set: function (e) {
                if (Z.pip) {
                    ...
                    x.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? Le : Ie), x.function(this.media.requestPictureInPicture) && (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture())
                }
            },
            get: function () {
                return Z.pip ? x.empty(this.media.webkitPresentationMode) ? this.media === document.pictureInPictureElement : this.media.webkitPresentationMode === Le : null
            }
        }], [{
            key: "supported",
            value: function (e, t, n) {
            ...
            value: function (e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    i = null;
                return x.string(e) ? i = Array.from(document.querySelectorAll(e)) : x.nodeList(e) ? i = Array.from(e) : x.array(e) && (i = e.filter(x.element)), x.empty(i) ? null : i.map(function (e) {
                    return new t(e, n)
                })
            }
        }]), t
